...
"""
===============================================================================
FlwrAI: Hoya Species Classifier - FINAL VERSION
...
def main():
    ...
    with tab1:
        ...
        with col1:
            ...
            st.markdown("**FlwrAI** uses ML to identify *Hoya* species from pollinaria measurements. Input 10 measurements → Get AI prediction + confidence!")
        with col2:
    ...
    with tab2:
        ...
        with col2:
            st.markdown(f"**Models:** RF, XGBoost, LightGBM, CatBoost, MLP, Voting")
    ...
    # ========================================================================
    # BOTTOM: MANUAL INPUT (LEFT) | ANALYSIS REPORT (RIGHT)
    # ========================================================================
