# HOYA-FLWR-AI · Philippine Hoya Clade Classifier
...
**Dataset Owner:** Fernando B. Aurigue, Retired Career Scientist, DOST Philippine Nuclear Research Institute (DOST-PNRI)
**Presented at:** National Summit on Botanic Gardens and Arboreta, May 25–29, 2026
...
The morphometric dataset was assembled and curated by **Fernando B. Aurigue**, Retired Career Scientist of the **DOST Philippine Nuclear Research Institute (DOST-PNRI)**, over decades of pollinarium fieldwork on Philippine *Hoya*. All measurements remain his intellectual contribution and are used here with his permission.
...
If you use this work, please cite **both** the classifier and the underlying dataset:
...
@dataset{aurigue2026hoya,
  title={Philippine Hoya Pollinarium Morphometric Database},
  author={Aurigue, Fernando B.},
  year={2026},
  institution={DOST Philippine Nuclear Research Institute (DOST-PNRI)}
}
```
...
- **Dataset Owner:** Fernando B. Aurigue, Retired Career Scientist, DOST Philippine Nuclear Research Institute (DOST-PNRI). The morphometric corpus underlying this work was assembled and curated by Mr. Aurigue over decades of pollinarium fieldwork on Philippine *Hoya* and is used here under his permission.
